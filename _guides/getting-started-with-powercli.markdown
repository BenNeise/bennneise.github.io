...
tags: powershell
image: /assets/guide-images/powershell/powershell-logo.png
updated: 2026-06-12
---
...
PowerShell works using _CMDlets_. These are typically fairly descriptive, and great care has been taken to make them work in a consistent and logical way. Most CMDlets follow the format _verb-noun_, with modifiers for the target of the action, and any CMDlet specific options. They are not case sensitive.
...
In order to use PowerCLI, install the official module from the PowerShell Gallery (PowerShell 5.1 or PowerShell 7+):

`Install-Module -Name VMware.PowerCLI -Scope CurrentUser`

After installing you can import the module manually if needed:
